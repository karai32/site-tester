  ...
  async run({ url }) {
    ...
    try {
      ...
      return problems.length === 0
        ? { id: this.id, title: this.title, pageUrl: url, status: 'passed', message: `Проверено ${checkedCount} страниц (обход сайта, глубина ${maxDepth}, без учёта главной), BreadcrumbList есть везде.` }
